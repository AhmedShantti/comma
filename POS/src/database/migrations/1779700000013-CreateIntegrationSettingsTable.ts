    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'webhook_secret_key', type: 'text', isNullable: true, select: false },
          { name: 'webhook_events', type: 'jsonb', default: `'[]'` },
          { name: 'api_key', type: 'text', isNullable: true, select: false },
          { name: 'api_secret', type: 'text', isNullable: true, select: false },
